...
public class RecommendAdapter  extends RecyclerView.Adapter<RecommendAdapter.GeneralViewHolder> {
    Context context;
    ArrayList<Book> books;
    public RecommendAdapter(Context context,ArrayList<Book> books){
    ...
    @Override
    public void onBindViewHolder(@NonNull GeneralViewHolder viewHolder, int i) {
        ...
        //dieu nay kha la don gian : dung la nhu vay :
